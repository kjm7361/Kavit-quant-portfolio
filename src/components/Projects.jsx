...
const projects = [
  ...
  },
  {
    ...
    tags: ['Python', 'hmmlearn', 'NumPy', 'Pandas', 'Matplotlib'],
    icon: '🧠',
  ...
  },
  {
    ...
    subtitle: 'Streamlit · Alpaca paper trading · backtesting',
    desc: 'Developed a multi-page Streamlit application connected to Alpaca\'s paper trading environment. Structured the codebase across backtesting, signals, risk, and execution modules for scalability. Implemented portfolio analytics including equity curves, drawdowns, turnover, and performance metrics.',
    tags: ['Python', 'Streamlit', 'Alpaca API', 'Pandas', 'Plotly'],
    icon: '📊',
    gradient: 'linear-gradient(135deg, #1e3a8a 0%, #1d4ed8 50%, #2563eb 100%)',
    glow: 'rgba(37,99,235,0.45)',
    accent: '#93c5fd',
    github: 'https://github.com/kjm7361',
    stat: { label: 'Mar – Apr 2026', value: 'Python' },
  },
  {
    title: 'Intraday Microstructure Alpha & Execution Simulator',
    subtitle: 'Synthetic limit order book · execution quality',
    desc: 'Built a synthetic limit order book simulator to model market microstructure dynamics. Engineered order book imbalance, microprice drift, and trade-flow signals for alpha generation. Simulated intraday trading behavior to study execution quality, liquidity, and short-term price movement.',
