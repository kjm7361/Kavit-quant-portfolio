...
const projects = [
  ...
  },
  {
    ...
    subtitle: 'Full-featured personal finance tracker',
    desc: 'A full-featured personal expense tracking application built in Java. Provides budgeting, categorization, and analytics to help users manage and visualize their spending habits.',
    tags: ['Java', 'OOP', 'Data Structures', 'CLI'],
    icon: '💰',
    gradient: 'linear-gradient(135deg, #78350f 0%, #92400e 50%, #b45309 100%)',
    glow: 'rgba(146,64,14,0.45)',
    accent: '#fcd34d',
    github: 'https://github.com/kjm7361/advance-expense-tracker',
    stat: { label: 'Language', value: 'Java' },
  },
]
