...
const projects = [
  {
    ...
    subtitle: 'Full-stack quantitative trading & risk platform',
    desc: 'Full-stack quantitative trading, risk management, and portfolio analytics platform built with Python and Streamlit. Includes multi-strategy backtesting, live market data, options pricing, Monte Carlo simulation, pairs trading, and market regime detection.',
    tags: ['Python', 'Streamlit', 'Plotly', 'Pandas', 'NumPy', 'yfinance'],
    icon: '📈',
    gradient: 'linear-gradient(135deg, #064e3b 0%, #065f46 35%, #047857 60%, #059669 100%)',
    glow: 'rgba(5,150,105,0.4)',
    accent: '#34d399',
    github: 'https://github.com/kjm7361/quant-trading-platform',
    featured: true,
    stat: { label: 'Language', value: 'Python' },
  },
  {
    title: 'microstructure-execution-simulator',
    subtitle: 'Intraday alpha & synthetic limit order book',
    desc: 'Intraday Microstructure Alpha & Execution Simulator — a Python-based quantitative finance project that simulates how short-term trading activity behaves inside a synthetic limit order book.',
  ...
  {
    title: 'financial-price-forecasting-engine',
    subtitle: 'ML-powered price prediction pipeline',
    desc: 'A Python-based financial price forecasting engine leveraging machine learning models to predict asset price movements. Implements feature engineering, model training, and backtesting pipelines.',
    tags: ['Python', 'scikit-learn', 'Pandas', 'NumPy'],
    icon: '🔮',
    gradient: 'linear-gradient(135deg, #1e3a8a 0%, #1d4ed8 50%, #2563eb 100%)',
    glow: 'rgba(37,99,235,0.45)',
    accent: '#93c5fd',
    github: 'https://github.com/kjm7361/financial-price-forecasting-engine',
    stat: { label: 'Language', value: 'Python' },
  },
  {
    title: 'projectpilot-ai',
    subtitle: 'AI-powered project management assistant',
    desc: 'An AI-powered project management tool built with JavaScript. Helps teams plan, track, and execute projects using intelligent automation and natural language interfaces.',
    tags: ['JavaScript', 'Node.js', 'AI', 'REST API'],
    icon: '🤖',
    gradient: 'linear-gradient(135deg, #7c2d12 0%, #9a3412 50%, #b45309 100%)',
    glow: 'rgba(180,83,9,0.45)',
    accent: '#fbbf24',
    github: 'https://github.com/kjm7361/projectpilot-ai',
    stat: { label: 'Language', value: 'JavaScript' },
  },
]
